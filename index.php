...
<body class="dashboard dashboard_1">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <div class="full">
                            ...
                            <div class="right_topbar">
                                <div class="icon_info">
                                    <ul>
                                        <li><a href="#!"><i class="fa fa-shopping-cart"></i><span class="badge">2</span></a></li>
                                ...
                                <div class="lista-carrito d-none">
                                    <p>Ventas de carrito</p>
                                </div>
                            </div>
                        </div>
                    </nav>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="full counter_section margin_bottom_30">
                                    ...
                                    <div class="counter_no">
                                        <div>
                                            <p class="total_no" id="totalClientes">2500</p>
                                                ...
                                                <div class="tabbar padding_infor_info">
                                                    <nav>
                                                        <div class="nav nav-tabs" id="nav-tab1" role="tablist">
                                                            <a class="nav-item nav-link active" id="nav-productos-tab2" data-toggle="tab" href="#productos" role="tab" aria-controls="productos" aria-selected="true">Productos</a>
                                                            <a class="nav-item nav-link" id="nav-profile-tab2" data-toggle="tab" href="#membresia" role="tab" aria-controls="membresia" aria-selected="false">Membresías</a>
                                                            <a class="nav-item nav-link" id="nav-clientes-tab2" data-toggle="tab" href="#nav-clientes_s2" role="tab" aria-controls="nav-clientes_s2" aria-selected="true">Clientes</a>
                                                        </div>
                                                    </nav>
                                                    <div class="tab-content" id="nav-tabContent_3">
                                                        ...
                                                        <div class="tab-pane fade" id="membresia" role="tabpanel" aria-labelledby="nav-profile-tab">
                                                            <!-- Membresías -->
                                                        ...
                                                        <div class="tab-pane fade show" id="nav-clientes_s2" role="tabpanel" aria-labelledby="nav-clientes-tab">
                                                            <!-- Clientes -->
                                        ...
                                        <div class="col-md-12">
                                            <div class="tab_style2">
                                                <div class="tabbar padding_infor_info">
                                                    <nav>
                                                        <div class="nav nav-tabs" id="nav-tab1" role="tablist">
                                                            <a class="nav-item nav-link active" id="nav-profile-tab2" data-toggle="tab" href="#nav-profile_s2" role="tab" aria-controls="nav-profile_s2" aria-selected="false">Usuarios</a>
                                                    ...
                                                    <div class="tab-content" id="nav-tabContent_2">
                                                        <div class="tab-pane fade show active" id="nav-profile_s2" role="tabpanel" aria-labelledby="nav-profile-tab">
                                                            <!-- Usuarios -->
                                                            <div class="row column1">
                                                                <div class="white_shd full margin_bottom_30">
                                                                    <div class="full graph_head d-flex justify-content-between">
                                                                        ...
                                                                        <i class="fa fa-plus fa-3x blue1_color"></i>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12" style="overflow-y: scroll;height:500px;">
                                                                    <div class="white_shd full margin_bottom_30">
                                                                        <div class="full graph_head d-flex justify-content-between">
                                                                            ...
                                                                            <div class="heading1 margin_0 pr-5">
 ...
 <!--    <script>
        ...
        var clientes = new PerfectScrollbar('#clientes');
        var productos = new PerfectScrollbar('#ventaProductos');
    </script> -->
    <!-- custom js -->
